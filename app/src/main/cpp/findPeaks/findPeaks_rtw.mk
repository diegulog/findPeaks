###########################################################################
## Makefile generated for component 'findPeaks'. 
## 
## Makefile     : findPeaks_rtw.mk
## Generated on : Sun Nov 07 21:11:20 2021
## Final product: ./findPeaks.a
...
PRODUCT_NAME              = findPeaks
MAKEFILE                  = findPeaks_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2021a.app
MATLAB_BIN                = /Applications/MATLAB_R2021a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/diegulog/blautic/pikkulab/recursos/codegen/lib/findPeaks
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/diegulog/blautic/pikkulab/recursos -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=findPeaks
...
SRCS = $(START_DIR)/findPeaks_data.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp $(START_DIR)/findPeaks_initialize.cpp $(START_DIR)/findPeaks_terminate.cpp $(START_DIR)/findPeaks.cpp $(START_DIR)/blockedSummation.cpp $(START_DIR)/eml_setop.cpp $(START_DIR)/sort.cpp $(START_DIR)/sortIdx.cpp
...
OBJS = findPeaks_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o findPeaks_initialize.o findPeaks_terminate.o findPeaks.o blockedSummation.o eml_setop.o sort.o sortIdx.o
...
%.o : /Users/diegulog/blautic/pikkulab/recursos/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/diegulog/blautic/pikkulab/recursos/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


findPeaks_data.o : $(START_DIR)/findPeaks_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
findPeaks_initialize.o : $(START_DIR)/findPeaks_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


findPeaks_terminate.o : $(START_DIR)/findPeaks_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
